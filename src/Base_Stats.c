...
const struct BaseStats gBaseStats[] = 
{
	...
	[SPECIES_LUXRAY] =
	{
		...
		.evYield_SpDefense 	= 0,
		.evYield_Speed 		= 0,
		.item1 = ITEM_ELECTRIC_SEED,
		.item2 = ITEM_ASSAULT_VEST,
		.genderRatio = PERCENT_FEMALE(50),
		.eggCycles = 20,
		.friendship = 50,
		.growthRate = GROWTH_MEDIUM_SLOW,
	...
	[SPECIES_DRIFBLIM] =
	{
		...
		.evYield_SpDefense 	= 0,
		.evYield_Speed 		= 0,
		.item1 = ITEM_AIR_BALLOON,
		.item2 = ITEM_KASIB_BERRY,
		.genderRatio = PERCENT_FEMALE(50),
		.eggCycles = 30,
		.friendship = 50,
		.growthRate = GROWTH_FLUCTUATING,
	...
	[SPECIES_DREDNAW_GIGA] =
{
	...
	[SPECIES_URSHIFU_SINGLE_GIGA] =
	{
		...
		.eggGroup1 = EGG_GROUP_UNDISCOVERED,
		.eggGroup2 = EGG_GROUP_UNDISCOVERED,
		.ability1 = ABILITY_ADAPTABILITY, //UNSEEN FIST NOT DEFINED
		.ability2 = ABILITY_NONE,
		.safariZoneFleeRate = 0,
		.hiddenAbility = ABILITY_NONE,
		.noFlip = TRUE,
