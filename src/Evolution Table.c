...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_TYNAMO] =           {{EVO_LEVEL, 31, SPECIES_EELEKTRIK, 0}},
	...
	[SPECIES_MIENFOO] =          {{EVO_LEVEL, 44, SPECIES_MIENSHAO, 0}},
	[SPECIES_GOLETT] =           {{EVO_LEVEL, 39, SPECIES_GOLURK, 0}},
	[SPECIES_PAWNIARD] =         {{EVO_LEVEL, 41, SPECIES_BISHARP, 0}},
	[SPECIES_RUFFLET] =          {{EVO_LEVEL, 41, SPECIES_BRAVIARY, 0}/*,
								   {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_BRAVIARY_H, 0}*/},
	[SPECIES_VULLABY] =          {{EVO_LEVEL, 44, SPECIES_MANDIBUZZ, 0}},
